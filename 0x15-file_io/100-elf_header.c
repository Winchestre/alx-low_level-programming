 ...
 * @e_ident: A poiner to an array containing the ELF version
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI:                             ");
...
/**
 * print_type - Prints the typr of an ELF header
 * @e_type: The ELF type
 * @e_ident: A pointer to  an array containing the ELF class
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * main - Displays information contained in the ELF header at the
